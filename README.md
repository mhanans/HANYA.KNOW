...
- Dedicated **Pre-Sales** menu with the AI Project Assessment Engine blueprint, covering UI specs, technical workflow, and data models (see `docs/pre-sales-ai-project-assessment-engine.md`).
